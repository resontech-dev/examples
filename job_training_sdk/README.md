...
```bash
cp .env.example .env
# Edit .env — fill in RESON_EMAIL, RESON_PASSWORD, RESON_S3_KEY, RESON_S3_SECRET.
# Keys live at https://app.reson.tech/account
```
...
[submit] dashboard: https://app.reson.tech/dashboard/jobs/clx1234abcdef0000
```
