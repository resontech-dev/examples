"""
Talk to the deployed the GLM-4.5-Air premium chat (TP=4) endpoint (OpenAI protocol).
...
DEFAULT_PROMPT = "Plan the steps to migrate a monolith's billing module to a service. Be specific."
...
def main() -> None:
    ...
    print("─" * 72)
    messages = [
        {"role": "system", "content": "You are a precise, senior technical assistant."},
