"""
Talk to the deployed the gpt-oss-20b business chat endpoint (OpenAI protocol).
...
DEFAULT_PROMPT = "Draft a two-paragraph reply declining a vendor renewal politely."
...
def main() -> None:
    ...
    print("─" * 72)
    messages = [
        {"role": "system", "content": "You are a concise, professional business assistant. Reasoning: medium"},
