"""
Deploy the gpt-oss-20b RAG bundle (chat+embed+rerank) to ResonTech.
...
def main() -> None:
    ...
    inference = InferenceConfig(
        ...
        # Ordered GPU preference (>= 18 GB VRAM per card); first entry is filled first.
    ...
    job = sdk.rt_submit_inference(
        name=os.getenv("JOB_NAME", "gpt-oss-20b RAG Bundle"),
        inference=inference,
