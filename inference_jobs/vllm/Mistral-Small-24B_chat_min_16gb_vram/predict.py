"""
Talk to the deployed the Mistral Small 24B business chat endpoint (OpenAI protocol).
...
DEFAULT_PROMPT = "Summarize the key obligations of a data processor under GDPR in 5 bullets."
...
def main() -> None:
    ...
    print("─" * 72)
    messages = [
        {"role": "system", "content": "You are a concise, professional business assistant."},
